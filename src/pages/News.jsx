...
const newsItems = [
    ...
    },
    {
        ...
        excerpt: "In the Spring 2026 cohort of the Workshop, 9 teams were selected from across NYU and NYU Abu Dhabi. Of these, 3 teams from NYUAD are affiliated with CENTMED.<\br>Huge congratulations to the CENTMED teams for their work and achieving these amazing opportunities! \r\nGather more info about the program and the selected teams here",
        category: "Awards"
    }
